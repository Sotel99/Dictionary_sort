...
# Znacznik czasowy: 2021-05-27 16:01:34.080241
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -Wno-error=parentheses -std=c11 -xc -Wall -fdiagnostics-color -DINSIDE_DANTE -Wextra -D_ANSI_OUTPUT -Werror=vla -D_GNU_SOURCE -Wno-error=unused-parameter -Wno-error=implicit-fallthrough -Wno-parentheses -fmax-errors=5 -pedantic -Werror -ggdb3 
...
${OUTDIR}/main: ${OUTDIR}/dictionary.c.o ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o 
	@echo "Konsolidacja..."
	@${LD} ${LD_FLAGS} ${OUTDIR}/dictionary.c.o ${OUTDIR}/main.c.o ${OUTDIR}/unit_helper_v2.c.o ${OUTDIR}/unit_test_v2.c.o ${OUTDIR}/rdebug.c.o  -o ${OUTDIR}/main ${LD_LIBS}


${OUTDIR}/dictionary.c.o:  dictionary.c
	@echo "Budowanie pliku 'dictionary.o' z 'dictionary.c'..."
	${CC} ${CC_FLAGS} -c dictionary.c -o ${OUTDIR}/dictionary.c.o
